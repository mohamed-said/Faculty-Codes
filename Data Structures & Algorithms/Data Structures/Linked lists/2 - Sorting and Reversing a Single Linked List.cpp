...
//	out << "prev = " << node.getPrev() << "  Me = " << node.getData() << " next = " << node.getNext();
//	out << endl;
...
//				nPtr->setPrev(pPtr); //-----------------------------------------> added
				pPtr->setNext(nPtr);
//				nPtr->getNext()->setPrev(nPtr); //---------------------------> added
			}
		if (tail == pPtr)
			tail = tail->getNext();
	}
...
//			last->getNext()->setPrev(last); //------------------------> added
			delete temp;
		}
	}
